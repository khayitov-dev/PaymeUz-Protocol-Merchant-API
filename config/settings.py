...
SECRET_KEY = 'django-insecure-px7q2xz_-8w1h+09)%@bh+wg(had3p64)i34_veks2g42ag=u+'
...
PAYCOM_SETTINGS = {
    "TOKEN":"", # TOKEN =>  bu sizga payme tomonidan beriladigan kassa ID.
    "KASSA_ID": "",  # KASSA_ID =>  bu sizga payme tomonidan beriladigan kassa ID.
    "SECRET_KEY": "",   # SECRET_KEY =>  bu sizga payme tomonidan beriladigan SECRET_KEY.
    "ACCOUNTS": {
